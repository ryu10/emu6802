...
## 構成
  ...
  EMUZ80 基板の CPU ソケットピン配列は当然ながら Z80 準拠ですので、別途ブレッドボードに MC6802 を刺してジャンパ線で配線します。下図ではワイヤラッピング線を利用しています。線が細くバス配線が楽です。

![emu6802-breadboard](/img/emu6802bb.jpg)

## 配線

具体的な配線は下図のとおりです。図の右半分は PIC 内部の CLC と NCO の構成を説明するもので、実際に配線する必要はありません。

![schematic](/emu6802.kicad5/emu6802/emu6802_sch.pdf)
...
注：現行の HEX ファイルは PIC18F47Q84 ターゲットでビルドされています。
...
4. 電源投入するとシリアルポート（9600bps）から Mikbug を使用できます。メモリマップは SBC6800 と同じです。
